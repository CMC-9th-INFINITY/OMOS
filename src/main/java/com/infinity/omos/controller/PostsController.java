...
public class PostsController {
    ...
    public ResponseEntity<List<PostsDetailResponseDto>> selectPostsMatchingCategory(@PathVariable("category") Category category, Pageable pageable) {
        System.out.println("dfd");
        return ResponseEntity.ok(postsService.selectRecordsByCategory(category, pageable));
    }
